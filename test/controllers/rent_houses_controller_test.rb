...
class RentHousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent_house" do
    assert_difference('RentHouse.count') do
      post rent_houses_url, params: { rent_house: { address: @rent_house.address, age: @rent_house.age, name: @rent_house.name, note: @rent_house.note, rent: @rent_house.rent } }
    end
  ...
  test "should update rent_house" do
    patch rent_house_url(@rent_house), params: { rent_house: { address: @rent_house.address, age: @rent_house.age, name: @rent_house.name, note: @rent_house.note, rent: @rent_house.rent } }
