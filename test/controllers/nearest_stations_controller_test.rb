...
class NearestStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nearest_station" do
    assert_difference('NearestStation.count') do
      post nearest_stations_url, params: { nearest_station: { line: @nearest_station.line, minute: @nearest_station.minute, station: @nearest_station.station } }
    end
  ...
  test "should update nearest_station" do
    patch nearest_station_url(@nearest_station), params: { nearest_station: { line: @nearest_station.line, minute: @nearest_station.minute, station: @nearest_station.station } }
